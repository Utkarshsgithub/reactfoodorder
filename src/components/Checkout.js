...
function Checkout({ setProgress }) {
  ...
  const { zeroTotalAmount, removeAllProducts } = bindActionCreators(
    actionCreators,
    dispatch
  );
  ...
  return (
    <div className="center">
      <div className="checkout-page">
        <h1 className="center" style={{ margin: "25px 0px" }}>
          Checkout
        </h1>
        <form method="POST">
          <input
          ...
          <input
            ...
            required
          />
          <button className="btn-od" type="submit" onClick={submitData}>
            Order Done!
          </button>
        </form>
      </div>
